...
public class DBHelper extends SQLiteOpenHelper{
    ...
    public static final String COL_ITEM_NAME_TIME_CHECK = "item_name_time_check";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + TABLE_NAME_TIME + "(_id INTEGER PRIMARY KEY AUTOINCREMENT, " + COL_ITEM_NAME_TIME + " VARCHAR(255), " + COL_ITEM_NAME_TIME_CHECK + " VARCHAR(255), " + COL_TIME + " VARCHAR(255));");
